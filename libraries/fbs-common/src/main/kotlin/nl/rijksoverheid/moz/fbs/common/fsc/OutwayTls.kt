 ...
 * ```
 *
 * Alle drie de consumenten hangen aan dezelfde outway en dus aan hetzelfde anker: de
 ...
 * krijgt alleen verkeer dat daadwerkelijk door de outway loopt dit anker mee — een magazijn
 ...
 * anker onder een verkeerd gespelde naam niet als "geen anker" wegvalt.
 */
object OutwayTls {
