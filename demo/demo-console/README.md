...
|---|---|---|
| Info | ↻ per blok | Toont zonder te vragen de berichten per magazijn, de stroom, de storingen, de componenten, de gesimuleerde magazijnen (telling per gedrag, met de volledige lijst uitklapbaar), welke knopgroepen deze omgeving draagt en waarom er een ontbreekt, en de persona's met per persona of er een echt magazijn voor is. Berichten, stroom, storingen en componenten lezen mee met de toestandsbalk; de gesimuleerde magazijnen volgen elke 30 seconden en na elke actie, zolang het tabblad open staat; knoppen en persona's bij het laden. ↻ werkt een blok meteen bij. Elk blok zegt wanneer het bijgewerkt is, en een mislukte uitlezing laat de vorige stand staan met die melding erbij |
