...
#
# De andere smokes raken maar een deel van de stack: txlog en stub-upstream worden door geen
# enkele smoke aangeroepen, en de manager announce't ook prima terwijl inway of controller
# crash-loopt. Juist dat zijn de componenten waarvan de hostnet-overlay de poorten hernummert,
# dus een fout daarin moet luid falen in plaats van onder een groene keten te verdwijnen.
set -euo pipefail
